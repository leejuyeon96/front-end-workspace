...
function btn3() {
    const div = document.getElementsByClassId("testClass");
    console.log(div);
    console.log(div[0]);
}

function btn4() {
    const div = document.getElementsByClassName("testName");
    console.log(div);
}
...
function btn12() {
    ...
    if(check) {
        ...
        div2.classList.add("black"); //버튼하나로 합치기
    }
}
