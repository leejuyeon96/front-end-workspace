...
//         $(event.target).css('background-color', 'beige').text('마우스가 올라감'); //mouseenter
     
// });
//     // mouseleave 함수 배경색 hotpink, 텍스트 마우스가 내려감
...
$('#area1').on({
    mouseenter:function(event){$(event.target).css('background-color', 'beige').text('마우스가 올라감');},
